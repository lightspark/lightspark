...
void XMLList::sinit(Class_base* c)
{
	...
	c->isReusable=true;
	c->setDeclaredMethodByQName("length","",c->getSystemState()->getBuiltinFunction(_getLength,0,Class<Integer>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("attribute",AS3,c->getSystemState()->getBuiltinFunction(attribute,1,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("attributes",AS3,c->getSystemState()->getBuiltinFunction(attributes,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("child",AS3,c->getSystemState()->getBuiltinFunction(child,1,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("children",AS3,c->getSystemState()->getBuiltinFunction(children,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("contains",AS3,c->getSystemState()->getBuiltinFunction(contains,1,Class<Boolean>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("copy",AS3,c->getSystemState()->getBuiltinFunction(copy,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("descendants",AS3,c->getSystemState()->getBuiltinFunction(descendants,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("elements",AS3,c->getSystemState()->getBuiltinFunction(elements,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("normalize",AS3,c->getSystemState()->getBuiltinFunction(_normalize,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("parent",AS3,c->getSystemState()->getBuiltinFunction(parent),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("hasSimpleContent",AS3,c->getSystemState()->getBuiltinFunction(_hasSimpleContent,0,Class<Boolean>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("hasComplexContent",AS3,c->getSystemState()->getBuiltinFunction(_hasComplexContent,0,Class<Boolean>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	...
	c->prototype->setVariableByQName("valueOf","",c->getSystemState()->getBuiltinFunction(valueOf,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),DYNAMIC_TRAIT);
	c->setDeclaredMethodByQName("valueOf",AS3,c->getSystemState()->getBuiltinFunction(valueOf,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("toXMLString",AS3,c->getSystemState()->getBuiltinFunction(toXMLString,0,Class<ASString>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("text",AS3,c->getSystemState()->getBuiltinFunction(text,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("comments",AS3,c->getSystemState()->getBuiltinFunction(comments,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("processingInstructions",AS3,c->getSystemState()->getBuiltinFunction(processingInstructions,0,Class<XMLList>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("propertyIsEnumerable",AS3,c->getSystemState()->getBuiltinFunction(_propertyIsEnumerable,1,Class<Boolean>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("hasOwnProperty",AS3,c->getSystemState()->getBuiltinFunction(_hasOwnProperty,1,Class<Boolean>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
