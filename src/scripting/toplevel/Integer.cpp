...
void Integer::sinit(Class_base* c)
{
	...
	c->setVariableByQName("MAX_VALUE","",new Integer(numeric_limits<int32_t>::max()),CONSTANT_TRAIT);
	c->setVariableByQName("MIN_VALUE","",new Integer(numeric_limits<int32_t>::min()),CONSTANT_TRAIT);
