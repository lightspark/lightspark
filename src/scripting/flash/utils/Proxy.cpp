...
void Proxy::sinit(Class_base* c)
{
	...
	c->setDeclaredMethodByQName("isAttribute","",c->getSystemState()->getBuiltinFunction(_isAttribute,0,Class<Boolean>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
}
