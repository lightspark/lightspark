...
void ASError::sinit(Class_base* c)
{
	...
	c->setDeclaredMethodByQName("getStackTrace","",c->getSystemState()->getBuiltinFunction(_getStackTrace,0,Class<ASString>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
