...
public:
	...
	AVM1_FUNCTION_TYPE_DECL(AVM1XMLNode, hasChildNode);
	...
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, Attributes);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, ChildNodes);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, LastChild);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, NextSibling);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, NodeName);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, NodeType);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, NodeValue);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, ParentNode);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, PreviousSibling);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, Prefix);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, LocalName);
	AVM1_PROPERTY_TYPE_DECL(AVM1XMLNode, NamespaceURI);
};
