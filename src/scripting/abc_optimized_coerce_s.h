...
void abc_coerce_s_local_localresult(call_context* context);
void abc_coerce_s_constant_setslotnocoerce(call_context* context);
void abc_coerce_s_local_setslotnocoerce(call_context* context);
}

#endif /* SCRIPTING_ABC_OPTIMIZED_COERCE_S_H */
