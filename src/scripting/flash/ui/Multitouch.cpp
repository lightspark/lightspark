...
void Multitouch::sinit(Class_base* c)
{
	...
	c->setDeclaredMethodByQName("maxTouchPoints","",c->getSystemState()->getBuiltinFunction(getMaxTouchPoints,0,Class<Integer>::getClassUninitialized(c->getSystemState())),GETTER_METHOD,false);
	c->setDeclaredMethodByQName("supportedGestures","",c->getSystemState()->getBuiltinFunction(getSupportedGestures,0,Class<Vector>::getClassUninitialized(c->getSystemState())),GETTER_METHOD,false);
	c->setDeclaredMethodByQName("supportsGestureEvents","",c->getSystemState()->getBuiltinFunction(getSupportsGestureEvents,0,Class<Boolean>::getClassUninitialized(c->getSystemState())),GETTER_METHOD,false);
	c->setDeclaredMethodByQName("supportsTouchEvents","",c->getSystemState()->getBuiltinFunction(getSupportsTouchEvents,0,Class<Boolean>::getClassUninitialized(c->getSystemState())),GETTER_METHOD,false);
