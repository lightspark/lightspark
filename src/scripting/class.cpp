...
Class_inherit::Class_inherit(const QName& name, MemoryAccount* m, const traits_info *_classtrait, Global *_defobj):Class_base(name, m),tag(NULL),bindedToRoot(false),classtrait(_classtrait),definitionobject(_defobj)
{
