LIBOBJS = swf.o swftypes.o tags.o geometry.o actions.o frame.o input.o streams.o tags_stub.o logger.o vm.o asobjects.o abc.o
...
%.o: %.cpp
	g++ -pthread -g -O0 -c -o $@ $^ -D_GLIBCXX_NO_DEBUG `pkg-config --cflags libxml-2.0`
