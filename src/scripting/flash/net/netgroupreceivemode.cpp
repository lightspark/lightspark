...
void NetGroupReceiveMode::sinit(Class_base* c)
{
	CLASS_SETUP_NO_CONSTRUCTOR(c, ASObject, CLASS_SEALED|CLASS_FINAL);
	c->setVariableAtomByQName("EXACT",nsNameAndKind(),asAtomHandler::fromString(c->getSystemState(),"exact"),CONSTANT_TRAIT);
