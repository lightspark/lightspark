...
void DisplayObject::AVM1SetupMethods(Class_base* c)
{
	...
	c->prototype->setDeclaredMethodByQName("toString","",c->getSystemState()->getBuiltinFunction(AVM1_toString,0,Class<ASString>::getRef(c->getSystemState()).getPtr()),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("blendMode","",c->getSystemState()->getBuiltinFunction(_getBlendMode,0,Class<ASString>::getRef(c->getSystemState()).getPtr()),GETTER_METHOD,false,false);
	...
	c->prototype->setDeclaredMethodByQName("cacheAsBitmap","",c->getSystemState()->getBuiltinFunction(_getter_cacheAsBitmap,0,Class<Boolean>::getRef(c->getSystemState()).getPtr()),GETTER_METHOD,false,false);
	...
	c->prototype->setDeclaredMethodByQName("filters","",c->getSystemState()->getBuiltinFunction(_getter_filters,0,Class<Boolean>::getRef(c->getSystemState()).getPtr()),GETTER_METHOD,false,false);
