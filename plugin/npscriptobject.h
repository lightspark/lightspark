...
public:
	...
	// ExtIdentifier copy-constructor
...
public:
	...
	void copy(std::map<lightspark::ExtIdentifier, lightspark::ExtVariant>& dest) const;
...
public:
	...
	NPVariantObject(NPP _instance, const ExtVariant& value) : instance(_instance)
	{
