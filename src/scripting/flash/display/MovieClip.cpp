...
void MovieClip::AVM1SetupMethods(Class_base* c)
{
	...
	c->prototype->setDeclaredMethodByQName("attachMovie","",c->getSystemState()->getBuiltinFunction(AVM1AttachMovie),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("loadMovie","",c->getSystemState()->getBuiltinFunction(AVM1LoadMovie),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("unloadMovie","",c->getSystemState()->getBuiltinFunction(AVM1UnloadMovie),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("loadMovieNum","",c->getSystemState()->getBuiltinFunction(AVM1LoadMovieNum),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("createEmptyMovieClip","",c->getSystemState()->getBuiltinFunction(AVM1CreateEmptyMovieClip),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("removeMovieClip","",c->getSystemState()->getBuiltinFunction(AVM1RemoveMovieClip),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("duplicateMovieClip","",c->getSystemState()->getBuiltinFunction(AVM1DuplicateMovieClip),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("clear","",c->getSystemState()->getBuiltinFunction(AVM1Clear),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("moveTo","",c->getSystemState()->getBuiltinFunction(AVM1MoveTo),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("lineTo","",c->getSystemState()->getBuiltinFunction(AVM1LineTo),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("curveTo","",c->getSystemState()->getBuiltinFunction(AVM1CurveTo),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("lineStyle","",c->getSystemState()->getBuiltinFunction(AVM1LineStyle),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("beginFill","",c->getSystemState()->getBuiltinFunction(AVM1BeginFill),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("beginGradientFill","",c->getSystemState()->getBuiltinFunction(AVM1BeginGradientFill),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("endFill","",c->getSystemState()->getBuiltinFunction(AVM1EndFill),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("useHandCursor","",c->getSystemState()->getBuiltinFunction(Sprite::_getter_useHandCursor),GETTER_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("useHandCursor","",c->getSystemState()->getBuiltinFunction(Sprite::_setter_useHandCursor),SETTER_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("getNextHighestDepth","",c->getSystemState()->getBuiltinFunction(AVM1GetNextHighestDepth),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("attachBitmap","",c->getSystemState()->getBuiltinFunction(AVM1AttachBitmap),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("gotoAndStop","",c->getSystemState()->getBuiltinFunction(gotoAndStop),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("gotoAndPlay","",c->getSystemState()->getBuiltinFunction(gotoAndPlay),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("gotoandstop","",c->getSystemState()->getBuiltinFunction(gotoAndStop),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("gotoandplay","",c->getSystemState()->getBuiltinFunction(gotoAndPlay),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("stop","",c->getSystemState()->getBuiltinFunction(stop),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("play","",c->getSystemState()->getBuiltinFunction(play),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("getInstanceAtDepth","",c->getSystemState()->getBuiltinFunction(AVM1getInstanceAtDepth),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("getSWFVersion","",c->getSystemState()->getBuiltinFunction(AVM1getSWFVersion),NORMAL_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("menu","",c->getSystemState()->getBuiltinFunction(_getter_contextMenu),GETTER_METHOD,false,false);
	c->prototype->setDeclaredMethodByQName("menu","",c->getSystemState()->getBuiltinFunction(_setter_contextMenu),SETTER_METHOD,false,false);
