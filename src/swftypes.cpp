...
RunState::RunState():last_FP(-1),FP(0),next_FP(0),
	stop_FP(false),explicit_FP(false),inEnterFrame(false),gotoQueued(false),
	creatingframe(false),frameadvanced(false),advancedByTick(false)
{
}
