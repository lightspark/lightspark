...
public:
	...
	uint8_t* getCurrentPixBuf() const override;
	uint8_t* switchCurrentPixBuf(uint32_t w, uint32_t h) override;
	...
	void exec_glBindBuffer_GL_PIXEL_UNPACK_BUFFER(uint32_t buffer) override;
	...
	uint8_t* exec_glMapBuffer_GL_PIXEL_UNPACK_BUFFER_GL_WRITE_ONLY() override;
	void exec_glUnmapBuffer_GL_PIXEL_UNPACK_BUFFER() override;
	...
	void exec_glBufferData_GL_PIXEL_UNPACK_BUFFER_GL_STREAM_DRAW(int32_t size,const void* data) override;
	...
	void exec_glTexImage2D_GL_TEXTURE_2D_GL_UNSIGNED_BYTE(int32_t level,int32_t width, int32_t height,int32_t border, const void* pixels) override;
	...
	void exec_glPixelStorei_GL_UNPACK_ROW_LENGTH(int32_t param) override;
	void exec_glPixelStorei_GL_UNPACK_SKIP_PIXELS(int32_t param) override;
	void exec_glPixelStorei_GL_UNPACK_SKIP_ROWS(int32_t param) override;
	void exec_glTexSubImage2D_GL_TEXTURE_2D(int32_t level,int32_t xoffset,int32_t yoffset,int32_t width,int32_t height,const void* pixels, uint32_t w, uint32_t curX, uint32_t curY) override;
