...
#ifndef SCRIPTING_FLASH_FILTERS_GRADIENTBEVELFILTER_H
#define SCRIPTING_FLASH_FILTERS_GRADIENTBEVELFILTER_H 1
...
#endif // SCRIPTING_FLASH_FILTERS_GRADIENTBEVELFILTER_H
