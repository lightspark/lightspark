...
{	
	...
	REGISTER_GETTER_RESULTTYPE(c,keyCode,UInteger);
	REGISTER_GETTER_RESULTTYPE(c,shiftKey,Boolean);
	REGISTER_GETTER_RESULTTYPE(c,isRelatedObjectInaccessible,Boolean);
}
