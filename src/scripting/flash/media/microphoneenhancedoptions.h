...
#ifndef SCRIPTING_FLASH_MEDIA_MICROPHONEENHANCEDOPTIONS_H
#define SCRIPTING_FLASH_MEDIA_MICROPHONEENHANCEDOPTIONS_H 1
...
#endif /* SCRIPTING_FLASH_MEDIA_MICROPHONEENHANCEDOPTIONS_H */
