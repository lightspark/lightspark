...
void Matrix3D::sinit(Class_base* c)
{
	...
	c->setDeclaredMethodByQName("transformVectors","",Class<IFunction>::getFunction(c->getSystemState(),transformVectors),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("prepend","",Class<IFunction>::getFunction(c->getSystemState(),prepend),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("prependRotation","",Class<IFunction>::getFunction(c->getSystemState(),prependRotation),NORMAL_METHOD,true);
	...
	c->setDeclaredMethodByQName("copyColumnFrom","",Class<IFunction>::getFunction(c->getSystemState(),copyColumnFrom),NORMAL_METHOD,true);
	...
	c->setDeclaredMethodByQName("copyRowFrom","",Class<IFunction>::getFunction(c->getSystemState(),copyRowFrom),NORMAL_METHOD,true);
	c->setDeclaredMethodByQName("copyRowTo","",Class<IFunction>::getFunction(c->getSystemState(),copyRowTo),NORMAL_METHOD,true);
