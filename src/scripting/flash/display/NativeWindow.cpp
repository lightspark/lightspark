...
void NativeWindow::sinit(Class_base* c)
{
	...
	c->setDeclaredMethodByQName("startMove","",c->getSystemState()->getBuiltinFunction(startMove,0,Class<Boolean>::getClassUninitialized(c->getSystemState())),NORMAL_METHOD,true);
}
