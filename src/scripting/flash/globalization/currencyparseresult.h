...
#ifndef SCRIPTING_FLASH_GLOBALIZATION_CURRENCYPARSERESULT_H
#define SCRIPTING_FLASH_GLOBALIZATION_CURRENCYPARSERESULT_H 1
...
#endif /* SCRIPTING_FLASH_GLOBALIZATION_CURRENCYPARSERESULT_H */
