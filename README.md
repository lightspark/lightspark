...
```
sudo apt install git gcc g++ nasm cmake libcurl4-gnutls-dev libsdl2-dev libsdl2-mixer-dev libpango1.0-dev libcairo2-dev libavcodec-dev libswresample-dev libglew-dev librtmp-dev libjpeg-dev libavformat-dev liblzma-dev
```
