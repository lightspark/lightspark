...
#endif
void *loadOpenGLFunction(const char* funcname)
{
	void* ret = SDL_GL_GetProcAddress(funcname);
	if (ret == nullptr)
	{
		LOG(LOG_ERROR,"OpenGL function not found:"<<funcname);
		throw RunTimeException("Rendering: OpenGL driver misses needed function");
	}
	return ret;
}
#define LSLOADOPENGLFUNCTION(FUNCNAME,FUNCTYPE) FUNCNAME = (FUNCTYPE)loadOpenGLFunction(#FUNCNAME)
SDL_GLContext EngineData::createSDLGLContext(SDL_Window* widget)
{
	SDL_GLContext ret = SDL_GL_CreateContext(widget);
	if (!ret)
	{
	...
	LSLOADOPENGLFUNCTION(glBindBuffer,PFNGLBINDBUFFERPROC);
	LSLOADOPENGLFUNCTION(glBindFramebuffer,PFNGLBINDFRAMEBUFFERPROC);
	LSLOADOPENGLFUNCTION(glBindRenderbuffer,PFNGLBINDRENDERBUFFERPROC);
	LSLOADOPENGLFUNCTION(glBindTexture,PFNGLBINDTEXTUREPROC);
	LSLOADOPENGLFUNCTION(glBlendFuncSeparate,PFNGLBLENDFUNCSEPARATEPROC);
	LSLOADOPENGLFUNCTION(glBlendFunc,PFNGLBLENDFUNCPROC);
	LSLOADOPENGLFUNCTION(glBufferData,PFNGLBUFFERDATAPROC);
	LSLOADOPENGLFUNCTION(glBufferSubData,PFNGLBUFFERSUBDATAPROC);
	LSLOADOPENGLFUNCTION(glCheckFramebufferStatus,PFNGLCHECKFRAMEBUFFERSTATUSPROC);
	LSLOADOPENGLFUNCTION(glClear,PFNGLCLEARPROC);
	LSLOADOPENGLFUNCTION(glClearColor,PFNGLCLEARCOLORPROC);
	LSLOADOPENGLFUNCTION(glClearDepth,PFNGLCLEARDEPTHPROC);
	LSLOADOPENGLFUNCTION(glClearStencil,PFNGLCLEARSTENCILPROC);
	LSLOADOPENGLFUNCTION(glColorMask,PFNGLCOLORMASKPROC);
	LSLOADOPENGLFUNCTION(glCompileShader,PFNGLCOMPILESHADERPROC);
	LSLOADOPENGLFUNCTION(glCompressedTexImage2D,PFNGLCOMPRESSEDTEXIMAGE2DPROC);
	LSLOADOPENGLFUNCTION(glCreateProgram,PFNGLCREATEPROGRAMPROC);
	LSLOADOPENGLFUNCTION(glCreateShader,PFNGLCREATESHADERPROC);
	LSLOADOPENGLFUNCTION(glCullFace,PFNGLCULLFACEPROC);
	LSLOADOPENGLFUNCTION(glDeleteBuffers,PFNGLDELETEBUFFERSPROC);
	LSLOADOPENGLFUNCTION(glDeleteFramebuffers,PFNGLDELETEFRAMEBUFFERSPROC);
	LSLOADOPENGLFUNCTION(glDeleteProgram,PFNGLDELETEPROGRAMPROC);
	LSLOADOPENGLFUNCTION(glDeleteRenderbuffers,PFNGLDELETERENDERBUFFERSPROC);
	LSLOADOPENGLFUNCTION(glDeleteShader,PFNGLDELETESHADERPROC);
	LSLOADOPENGLFUNCTION(glDeleteTextures,PFNGLDELETETEXTURESPROC);
	LSLOADOPENGLFUNCTION(glDepthFunc,PFNGLDEPTHFUNCPROC);
	LSLOADOPENGLFUNCTION(glDepthMask,PFNGLDEPTHMASKPROC);
	LSLOADOPENGLFUNCTION(glDisableVertexAttribArray,PFNGLDISABLEVERTEXATTRIBARRAYPROC);
	LSLOADOPENGLFUNCTION(glDisable,PFNGLDISABLEPROC);
	LSLOADOPENGLFUNCTION(glDrawArrays,PFNGLDRAWARRAYSPROC);
	LSLOADOPENGLFUNCTION(glDrawBuffer,PFNGLDRAWBUFFERPROC);
	LSLOADOPENGLFUNCTION(glDrawElements,PFNGLDRAWELEMENTSPROC);
	LSLOADOPENGLFUNCTION(glEnableVertexAttribArray,PFNGLENABLEVERTEXATTRIBARRAYPROC);
	LSLOADOPENGLFUNCTION(glEnable,PFNGLENABLEPROC);
	LSLOADOPENGLFUNCTION(glFinish,PFNGLFINISHPROC);
	LSLOADOPENGLFUNCTION(glFlush,PFNGLFLUSHPROC);
	LSLOADOPENGLFUNCTION(glFramebufferRenderbuffer,PFNGLFRAMEBUFFERRENDERBUFFERPROC);
	LSLOADOPENGLFUNCTION(glFramebufferTexture2D,PFNGLFRAMEBUFFERTEXTURE2DPROC);
	LSLOADOPENGLFUNCTION(glFrontFace,PFNGLFRONTFACEPROC);
	LSLOADOPENGLFUNCTION(glGenBuffers,PFNGLGENBUFFERSPROC);
	LSLOADOPENGLFUNCTION(glGenerateMipmap,PFNGLGENERATEMIPMAPPROC);
	LSLOADOPENGLFUNCTION(glGenFramebuffers,PFNGLGENFRAMEBUFFERSPROC);
	LSLOADOPENGLFUNCTION(glGenRenderbuffers,PFNGLGENRENDERBUFFERSPROC);
	LSLOADOPENGLFUNCTION(glGenTextures,PFNGLGENTEXTURESPROC);
	LSLOADOPENGLFUNCTION(glGetAttribLocation,PFNGLGETATTRIBLOCATIONPROC);
	LSLOADOPENGLFUNCTION(glGetError,PFNGLGETERRORPROC);
	LSLOADOPENGLFUNCTION(glGetIntegerv,PFNGLGETINTEGERVPROC);
	LSLOADOPENGLFUNCTION(glGetProgramInfoLog,PFNGLGETPROGRAMINFOLOGPROC);
	LSLOADOPENGLFUNCTION(glGetProgramiv,PFNGLGETPROGRAMIVPROC);
	LSLOADOPENGLFUNCTION(glGetShaderInfoLog,PFNGLGETSHADERINFOLOGPROC);
	LSLOADOPENGLFUNCTION(glGetShaderiv,PFNGLGETSHADERIVPROC);
	LSLOADOPENGLFUNCTION(glGetString,PFNGLGETSTRINGPROC);
	LSLOADOPENGLFUNCTION(glGetTexImage,PFNGLGETTEXIMAGEPROC);
	LSLOADOPENGLFUNCTION(glGetUniformLocation,PFNGLGETUNIFORMLOCATIONPROC);
	LSLOADOPENGLFUNCTION(glLinkProgram,PFNGLLINKPROGRAMPROC);
	LSLOADOPENGLFUNCTION(glPixelStorei,PFNGLPIXELSTOREIPROC);
	LSLOADOPENGLFUNCTION(glPolygonMode,PFNGLPOLYGONMODEPROC);
	LSLOADOPENGLFUNCTION(glReadPixels,PFNGLREADPIXELSPROC);
	LSLOADOPENGLFUNCTION(glRenderbufferStorage,PFNGLRENDERBUFFERSTORAGEPROC);
	LSLOADOPENGLFUNCTION(glScissor,PFNGLSCISSORPROC);
	LSLOADOPENGLFUNCTION(glShaderSource,PFNGLSHADERSOURCEPROC);
	LSLOADOPENGLFUNCTION(glStencilFunc,PFNGLSTENCILFUNCPROC);
	LSLOADOPENGLFUNCTION(glStencilMask,PFNGLSTENCILMASKPROC);
	LSLOADOPENGLFUNCTION(glStencilOp,PFNGLSTENCILOPPROC);
	LSLOADOPENGLFUNCTION(glStencilOpSeparate,PFNGLSTENCILOPSEPARATEPROC);
	LSLOADOPENGLFUNCTION(glTexImage2D,PFNGLTEXIMAGE2DPROC);
	LSLOADOPENGLFUNCTION(glTexParameterf,PFNGLTEXPARAMETERFPROC);
	LSLOADOPENGLFUNCTION(glTexParameteri,PFNGLTEXPARAMETERIPROC);
	LSLOADOPENGLFUNCTION(glTexSubImage2D,PFNGLTEXSUBIMAGE2DPROC);
	LSLOADOPENGLFUNCTION(glVertexAttribPointer,PFNGLVERTEXATTRIBPOINTERPROC );
	LSLOADOPENGLFUNCTION(glViewport,PFNGLVIEWPORTPROC);
	LSLOADOPENGLFUNCTION(glUniform1i,PFNGLUNIFORM1IPROC);
	LSLOADOPENGLFUNCTION(glUniform1f,PFNGLUNIFORM1FPROC);
	LSLOADOPENGLFUNCTION(glUniform1fv,PFNGLUNIFORM1FVPROC);
	LSLOADOPENGLFUNCTION(glUniform2f,PFNGLUNIFORM2FPROC);
	LSLOADOPENGLFUNCTION(glUniform2fv,PFNGLUNIFORM2FVPROC);
	LSLOADOPENGLFUNCTION(glUniform4f,PFNGLUNIFORM4FPROC);
	LSLOADOPENGLFUNCTION(glUniform4fv,PFNGLUNIFORM4FVPROC);
	LSLOADOPENGLFUNCTION(glUniformMatrix4fv,PFNGLUNIFORMMATRIX4FVPROC);
	LSLOADOPENGLFUNCTION(glUseProgram,PFNGLUSEPROGRAMPROC);

	LSLOADOPENGLFUNCTION(glColorPointer,PFNGLCOLORPOINTERPROC);
	LSLOADOPENGLFUNCTION(glDisableClientState,PFNGLDISABLECLIENTSTATEPROC);
	LSLOADOPENGLFUNCTION(glEnableClientState,PFNGLENABLECLIENTSTATEPROC);
	LSLOADOPENGLFUNCTION(glGetTexEnviv,PFNGLGETTEXENVIVPROC);
	LSLOADOPENGLFUNCTION(glLoadIdentity,PFNGLLOADIDENTITYPROC);
	LSLOADOPENGLFUNCTION(glMatrixMode,PFNGLMATRIXMODEPROC);
	LSLOADOPENGLFUNCTION(glOrtho,PFNGLORTHOPROC);
	LSLOADOPENGLFUNCTION(glPopAttrib,PFNGLPOPATTRIBPROC);
	LSLOADOPENGLFUNCTION(glPopMatrix,PFNGLPOPMATRIXPROC);
	LSLOADOPENGLFUNCTION(glPushAttrib,PFNGLPUSHATTRIBPROC);
	LSLOADOPENGLFUNCTION(glPushMatrix,PFNGLPUSHMATRIXPROC);
	LSLOADOPENGLFUNCTION(glShadeModel,PFNGLSHADEMODELPROC);
	LSLOADOPENGLFUNCTION(glTexCoordPointer,PFNGLTEXCOORDPOINTERPROC);
	LSLOADOPENGLFUNCTION(glTexEnvi,PFNGLTEXENVIPROC);
	LSLOADOPENGLFUNCTION(glVertexPointer,PFNGLVERTEXPOINTERPROC);
