...
static const char* builtinStrings[] = {"any", "void", "prototype", "Function", "__AS3__.vec","Class", "http://adobe.com/AS3/2006/builtin","http://www.w3.org/XML/1998/namespace","xml","toString","valueOf","length","constructor",
									   ...
									   "text","null","true","false","global","init","onSetFocus","onResize","movieclip"
									  };
...
Vector2f SystemState::windowToStagePoint(const Vector2f& windowPos)
{
	Vector2 windowSize(renderThread->windowWidth, renderThread->windowHeight);
	Vector2 offset;
	Vector2f scale;
	stageCoordinateMapping(windowSize, offset, scale);
	return (windowPos-offset)/scale;
}
