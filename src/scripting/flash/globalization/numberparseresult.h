...
#ifndef SCRIPTING_FLASH_GLOBALIZATION_NUMBERPARSERESULT_H
#define SCRIPTING_FLASH_GLOBALIZATION_NUMBERPARSERESULT_H 1
...
#endif /* SCRIPTING_FLASH_GLOBALIZATION_NUMBERPARSERESULT_H */
